...
@section('title', 'Portal Belajar Google Cloud Arcade')
    ...
    <div class="container grid-2col">
      <div class="overview-img-wrapper">
        <div class="badge-shelf glass" style="padding: 24px;">
          ...
          <a href="{{ route('tentang') }}" class="btn btn-primary">Baca Tentang Program <i class="fa-solid fa-arrow-right"></i></a>
        </div>
      </div>
      ...
      <div class="overview-img-wrapper">
        <div class="badge-shelf glass" style="padding: 24px;">
          ...
          <a href="{{ route('cara-main') }}" class="btn btn-outline">Pelajari Langkah Main <i class="fa-solid fa-arrow-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="container grid-2col" style="margin-top: 30px;">
      <div class="overview-img-wrapper">
        <div class="badge-shelf glass" style="padding: 24px;">
          ...
          <a href="{{ route('kalkulator') }}" class="btn btn-primary">Kalkulator & Papan Skor <i class="fa-solid fa-trophy"></i></a>
        </div>
      </div>
      ...
      <div class="overview-img-wrapper">
        <div class="badge-shelf glass" style="padding: 24px;">
          ...
          <a href="{{ route('strategi') }}" class="btn btn-outline">Lihat Panduan Strategi <i class="fa-solid fa-chess-knight"></i></a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container text-center">
      ...
      <div class="gallery-grid" style="margin-bottom: 40px;">
        <div class="gallery-card glass" style="overflow: hidden;">
          <img src="{{ asset('assets/swag_unboxing_1.jpg') }}" alt="Google Cloud Arcade Swag Unboxing" style="height: 220px; width: 100%; object-fit: cover; display: block;">
        </div>
        <div class="gallery-card glass" style="overflow: hidden;">
          <img src="{{ asset('assets/swag_unboxing_2.jpg') }}" alt="Google Cloud Arcade Swag Package" style="height: 220px; width: 100%; object-fit: cover; display: block;">
        </div>
        <div class="gallery-card glass" style="overflow: hidden;">
          <img src="{{ asset('assets/swag_tier_2.jpg') }}" alt="Google Cloud Arcade Prize Tiers" style="height: 220px; width: 100%; object-fit: cover; display: block;">
        </div>
      </div>

      <a href="{{ route('galeri-swag') }}" class="btn btn-primary btn-lg">Lihat Semua Swag Musim Lalu <i class="fa-solid fa-images"></i></a>
    </div>
  </section>
